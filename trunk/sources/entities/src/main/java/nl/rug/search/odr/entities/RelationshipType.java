...
@NamedQueries(value = {
    ...
    @NamedQuery(name = RelationshipType.NAMED_QUERY_IS_NAME_USED,
    query = "SELECT COUNT(r) FROM RelationshipType r WHERE LOWER(r.name) = :name"),
    @NamedQuery(name = RelationshipType.NAMED_QUERY_GET_PUBLIC_TYPES,
    query = "SELECT r FROM RelationshipType r WHERE r.common = TRUE"),
    @NamedQuery(name = RelationshipType.NAMED_QUERY_BY_NAME,
    query = "SELECT r FROM RelationshipType r WHERE r.name = :relationshipType")
})
@Entity
public class RelationshipType extends BaseEntity<RelationshipType> {
    ...
    public static final String NAMED_QUERY_IS_NAME_USED = "RelationshipType.isUsed";
    public static final String NAMED_QUERY_BY_NAME = "RelationshipType.getByName";
