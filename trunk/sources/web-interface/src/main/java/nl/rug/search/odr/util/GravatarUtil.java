 ...
 * @deprecated use the Gravatar4Java library
 */
@Deprecated
public abstract class GravatarUtil {
    ...
    public static String getGravatar(String email, int size) {
        ...
        String url = String.format(GRAVATAR_URL, emailHash);

        return new QueryStringBuilder().setUrl(url).append("d", "mm").append("r", "g").append("s", size).toString();
    }
}
