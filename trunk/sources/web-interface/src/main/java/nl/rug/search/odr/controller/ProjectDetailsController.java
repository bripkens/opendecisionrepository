...
public class ProjectDetailsController {
    ...
    public String getTeXExportLinkLink() {
        return new QueryStringBuilder().setUrl(Filename.TEX_EXPORT).
                append(RequestParameter.ID, project.getId()).
                toString();
    }
    ...
    public void showRemoveProjectConfirmation(ActionEvent e) {
        JsfUtil.addJavascriptCall("odr.showProjectRemoveForm();");
    }
}
