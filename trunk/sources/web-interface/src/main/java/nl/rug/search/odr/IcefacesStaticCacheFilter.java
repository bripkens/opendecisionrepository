...
public class IcefacesStaticCacheFilter implements Filter {
    ...
    private static final String EXPIRATION_DELTA_PROPERTY_KEY = "odr.cache.ice.expiration";
    private static final long EXPIRATION_DELTA_DEFAULT = 86400; // seconds

    private static final String ICE_CACHE_ACTIVE_PROPERTY_KEY = "odr.cache.ice.active";
