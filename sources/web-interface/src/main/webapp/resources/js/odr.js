...
odr.Prefill = function() {
    ...
    this.init = function() {
        j("input.prefill").each(function() {
            ...
            this.prefillValue[id] = text;

            element.focus(this.inputFocus);

            element.blur(this.inputBlur);
    ...
    this.inputFocus = function() {
        ...
        if (element.val() == this.prefillValue[element.attr("id")]) {
            element.val("");
...
/*
 * This class enables JavaScript based preselection
...
odr.Toggling = function() {
    ...
    this.init = function() {
        j("a.togglelink").each(function() {
            ...
            button.click(function() {
                this.toggleSlideElement(element);
    ...
    this.toggleSlide = function(elementSelector) {
        this.toggleSlideElement(j(elementSelector));
    }
    ...
    this.toggleFade = function(elementSelector) {
        this.toggleFadeElement(j(elementSelector));
    }
}
