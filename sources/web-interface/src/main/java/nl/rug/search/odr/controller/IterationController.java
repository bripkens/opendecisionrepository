...
public class IterationController {
    ...
    private String stringIterationId;
    ...
    public void postConstruct() {
        ...
        if (result.isValid()) {
            ...
            if (request.getParameter(RequestParameter.ITERATION_ID) != null) {
                isUpdate = true;
                stringIterationId = request.getParameter(RequestParameter.ITERATION_ID);
            } else {
                isUpdate = false;
            }
            ...
            if (isUpdate) {
                try {
                    iterationId = Long.parseLong(stringIterationId);
                ...
                if (!project.getIterations().contains(iteration)) {
                    ...
                    validRequest = false;
                    return;
                } else if (stringIterationId != null && iteration == null) {
                    ErrorUtil.showInvalidIdError();
                    validRequest = false;
                    return;
                }
