...
public class FeedbackServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (System.getProperty("feedback.smtp.user") == null || System.getProperty("feedback.smtp.password") == null) {
            if (System.getProperty("feedback.smtp.user") != null) {
                session = Session.getInstance(props, new Authenticator(System.getProperty("feedback.smtp.user"), ""));
            } else {
