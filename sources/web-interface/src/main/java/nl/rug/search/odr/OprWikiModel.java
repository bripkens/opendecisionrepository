 ...
 */
public class OprWikiModel extends WikiModel {

    public OprWikiModel(String imageBaseURL, String linkBaseURL) {
        super(Configuration.DEFAULT_CONFIGURATION, imageBaseURL, linkBaseURL);
    }

    public static OprWikiModel getDefault() {
        String oprBase = System.getProperty("opr.base.href");
        return new OprWikiModel(oprBase.concat("/file/${image}"),
                oprBase.concat("/file/${title}"));
    }
    ...
    public void parseInternalImageLink(String imageNamespace, String rawImageLink) {
        if (fExternalImageBaseURL != null) {
            ...
            appendExternalImageLink(imageSrc, imageName);
        }
    }
