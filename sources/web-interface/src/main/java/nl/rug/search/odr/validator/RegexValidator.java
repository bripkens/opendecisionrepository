...
public class RegexValidator implements Validator {
    ...
    public static final String REGEX_MISMATCH_ID =
         "nl.rug.search.odr.validator.RegexValidator.REGEX";
    ...
    public static final String INPUTCHARSET_MISMATCH_ID =
         "nl.rug.search.odr.validator.RegexValidator.INPUTCHARS";
    ...
    public static final String STARTSWITH_MISMATCH_ID =
         "nl.rug.search.odr.validator.RegexValidator.STARTSWITH";
