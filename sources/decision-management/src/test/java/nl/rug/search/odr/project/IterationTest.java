...
//        //################################################################
    ...
    public void intersectionTest() {
        ...
        GregorianCalendar startCal1 = new GregorianCalendar(2010, 1, 15);
        GregorianCalendar endCal1 = new GregorianCalendar(2014, 1, 17);


        GregorianCalendar startCal6 = new GregorianCalendar(2010, 1, 18);
        GregorianCalendar endCal6 = new GregorianCalendar(2011, 1, 19);

        GregorianCalendar startCal7 = new GregorianCalendar(2011, 1, 20);
        GregorianCalendar endCal7 = new GregorianCalendar(2013, 2, 2);
