...
public abstract class AbstractEjbTest {
    ...
    private static class ContainerHolder {
        ...
        static {
            ...
            moveFile("./target/classes/META-INF/ejb-jar.xml",
                    "./target/classes/META-INF/ejb-jar.xml.backup", true);
            ...
            moveFile("./target/classes/META-INF/persistence.xml.backup",
                    "./target/classes/META-INF/persistence.xml", false);
            moveFile("./target/classes/META-INF/ejb-jar.xml.backup",
                    "./target/classes/META-INF/ejb-jar.xml", false);
        }
    }
}
